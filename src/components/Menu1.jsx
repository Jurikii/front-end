  ...
  return (
    <header className={`${styles.menu} ${className}`}>
      ...
      <div className={styles.perfilUsuarioArea}>
        <NavLink to="/configuracoes" className={styles.botaoAcaoIcon}>
          <img className={styles.iconNotificacao} alt="Configurações" src="/Vector.svg" />
        </NavLink>
        <button className={styles.botaoAcaoIcon}>
          <img className={styles.iconConfig} alt="Notificações" src="/Vector1.svg" />
        </button>
