        ...
        <div className={styles.coroa}>
          ...
          <div className={styles.planoGratuito}>
            ...
            <div className={styles.risco}>
              <div className={styles.verDetalhesDo} onClick={handleClick} role="button" tabIndex={0}>Ver detalhes do plano</div>
            </div>
          </div>
        </div>
        <div className={styles.btnVerPlanos} onClick={handleClick} role="button" tabIndex={0}>
          <div className={styles.verPlanosGratuitos}>Ver planos disponíveis</div>
        </div>
      </div>
    </section>
  );
