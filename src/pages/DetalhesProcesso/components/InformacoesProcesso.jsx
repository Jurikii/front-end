...
import { CORES_CATEGORIA, STATUS } from "../../MeusProcessos/data/processos";
...
const InformacoesProcesso = ({ processo }) => {
  ...
  const statusColor =
    processo.status === STATUS.EM_ANDAMENTO
      ...
      <div className={styles.list}>
        <div className={styles.row}>
          <div className={styles.labelGroup}>
            <img className={styles.icon} alt="" src="/Vector4.svg" />
        ...
        <div className={styles.row}>
          <div className={styles.labelGroup}>
            <img className={styles.icon} alt="" src="/Vector5.svg" />
            <h3 className={styles.label}>Situação atual</h3>
          </div>
          <h3 className={`${styles.value} ${styles.statusValue}`} style={{ color: statusColor }}>{processo.status}</h3>
        </div>
        <div className={styles.divider} />
